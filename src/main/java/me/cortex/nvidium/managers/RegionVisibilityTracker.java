...
import static org.lwjgl3.opengl.GL42.GL_COMMAND_BARRIER_BIT;
import static org.lwjgl3.opengl.GL42.glMemoryBarrier;
import static org.lwjgl3.opengl.GL43C.GL_SHADER_STORAGE_BARRIER_BIT;
import static org.lwjgl3.opengl.NVMeshShader.glDrawMeshTasksNV;
...
public class RegionVisibilityTracker {
    private final Shader shader = Shader.make()
            ...
            .addSource(FRAGMENT, ShaderLoader.parse(new  ResourceLocation("nvidium", "occlusion/queries/region/fragment.frag")))
            .compile();
